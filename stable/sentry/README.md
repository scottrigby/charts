...
It also packages the [PostgreSQL](https://github.com/helm/charts/tree/master/stable/postgresql) and [Redis](https://github.com/helm/charts/tree/master/stable/redis) which are required for Sentry.
