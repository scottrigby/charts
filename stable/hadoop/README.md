...
The [Zeppelin Notebook](https://github.com/helm/charts/tree/master/stable/zeppelin) chart can use the hadoop config for the hadoop cluster and use the YARN executor:
